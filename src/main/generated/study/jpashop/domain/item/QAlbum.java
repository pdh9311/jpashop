...
public class QAlbum extends EntityPathBase<Album> {
    ...
    private static final long serialVersionUID = -1267415076L;
    ...
    //inherited
    public final ListPath<study.jpashop.domain.Category, study.jpashop.domain.QCategory> categories = _super.categories;
